...
CREATE TABLE Marks (
	id serial PRIMARY KEY,
	student_id INT NOT NULL REFERENCES Students(id),
	std_id INT NOT NULL REFERENCES subs_teachs_dirs(id),
	mark smallint
);
...
CREATE TABLE lessons_schedule (
	id serial PRIMARY KEY,
	subject_id INT NOT NULL REFERENCES subs_teachs_dirs(id),
	time_id INT NOT NULL REFERENCES timetable(id),
	date DATE NOT NULL
);

CREATE TABLE attendance (
	id serial PRIMARY KEY,
	scedule_id INT NOT NULL REFERENCES lessons_schedule(id),
	student_id INT NOT NULL REFERENCES Students(id),
	presense boolean NOT NULL
);
...
VALUES
('Иванов Иван Алексеевич', '2002-11-23', 'г.Новосибирск ул.Добролюбова д.34', 'qwe@yandex.ru', 1, False),
('Очаков Николай Александрович', '2002-06-30', 'г.Новосибирск ул.Красный проспект д.6', 'fgvbgf@mail.ru', 1, False),
('Суворов Дмитрий Иванович', '2002-05-12', 'г.Новкузнецк ул.Зеленая д.342', 'qgbfgbfwe@mail.ru', 1, True),
('Конфеткин Иван Александрович', '2002-03-18', 'г.Колывань ул.Кирова д.76', 'qwbfgbe@yandex.ru', 1, False),
('Павлова Анна Ивановна', '2003-05-01', 'г.Новосибирск ул.Пушкина д.23', 'qwbfgbe@mail.ru', 1, True),
('Камчаткин Дмитрий Александрович', '2001-03-18', 'г.Новосибирск ул.Добролюбова д.145', 'gbf@gmail.com', 1, True),
('Куприн Юлия Сергеевна', '2002-02-27', 'г.Томск ул.Бориса Богаткова д.34', 'qwbfgbfe@mail.ru', 1, True);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Коалов Иван Иванович', '2002-11-01', 'г.Новосибирск ул.Чурчхелы д.35', 'qbwe@mail.ru', 2, True),
('Какич Дмитрий Иванович', '2002-11-02', 'г.Томск ул.Церковная д.42', 'lhg@yandex.ru', 2, False),
('Зубрин Иван Алексеевич', '2002-11-03', 'г.Новкузнецк ул.Золотая д.64', 'jghjg@mail.ru', 2, True),
('Козлов Николай Иванович', '2002-11-04', 'г.Томск ул.Добролюбова д.54', 'vsdv@yandex.ru', 2, True),
('Урлик Иван Иванович', '2002-11-07', 'г.Новосибирск ул.Каменная д.45', 'vdfdfb@mail.ru', 2, False),
('Мещанова Юлия Иванович', '2002-12-03', 'г.Томск ул.Кремлевская д.45', 'fbdfbdf@yandex.ru', 2, False),
('Боярский Тарас Александрович', '2002-10-09', 'г.Томск ул.Купленная д.54', 'bdfbd@mail.ru', 2, False),
('Туркин Иван Алексеевич', '2002-06-17', 'г.Томск ул.Довлатова д.68', 'bfdbn@mail.ru', 2, False);


insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Кравченко Евгений Иоанович', '2002-12-31', 'г.Новосибирск ул.Дровникова д.286', 'bfdb@mail.ru', 3, True),
('Наров Иван Александрович', '2002-09-02', 'г.Новосибирск ул.Пролетариата д.13', 'qwngfnge@yandex.ru', 3, False),
('Прохоров Дмитрий Алексеевич', '2002-11-11', 'г.Томск ул.Дремова д.251', 'ngfn@mail.ru', 3, True),
('Паничкин Николай Иванович', '2002-11-13', 'г.Томск ул.Травникова д.321', 'nfgnf@gmail.com', 3, True),
('Дорогина Анна Иванович', '2002-09-01', 'г.Колывань ул.Добролюбова д.51', 'fnngn@mail.ru', 3, False),
('Дратутин Николай Александрович', '2002-04-19', 'г.Новосибирск ул.Труда д.28', 'ddddddddd@yandex.ru', 3, True),
('Досвиданя Дмитрий Иванович', '2002-05-27', 'г.Томск ул.Мира д.48', 'fdbfbdf@mail.ru', 3, False),
('Кукиш Иван Александрович', '2002-02-04', 'г.Томск ул.Земляничная д.64', 'lkji@yandex.ru', 3, False),
('Карпова Юлия Иванович', '2002-01-03', 'г.Новкузнецк ул.Кубышкина д.564', 'sdfs@yandex.ru', 3, False);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Крылова Ульяна Ильинична', '2002-11-08', 'г. Новосибирск, ул.Якуба Коласа, д.6', 'efim.mosh@outlook.com', 4, True),
('Харитонова Милана Демьяновна', '2001-11-20', 'г.Бердск, ул.Мирная, д.2 кв.84', 'yurin06121967@gmail.com', 4, False),
('Головин Александр Дмитриевич', '2002-01-03', 'г.Новосибирск, ул.Речная, д.11 кв.126', 'in.sarna@outlook.com', 4, False),
('Гордеева Ксения Артёмовна', '2000-02-18', 'г.Новосибирск, ул.Минская, д.21 кв.111', 'pelageya1405@hotmail.com', 4, True),
('Лебедев Арсений Алексеевич', '2003-07-25', 'г.Новосибирск, ул.Победы, д.12 кв.214', 'sem82@ya.ru', 4, False),
('Смирнов Кирилл Михайлович', '2002-12-25', 'г.Куйбышев, уд.Победы, д.14 кв.130', 'poln25121978@rambler.ru', 4, True),
('Александров Игорь Олегович', '2002-02-06', 'г.Новосибирск, ул.Космонавтов, д.19 кв.103', 'aton2899@rambler.ru', 4, True);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Николаев Илья Егорович', '2002-06-02', 'г.Новосибирск, Луговая ул., д. 8 кв.148', 'konstantin08111969@outlook.com', 5, True),
('Воробьева Анна Данииловна', '2003-05-24', 'г.Новосибирск, Космонавтов ул., д. 19 кв.103', 'arkadiy27071985@ya.ru', 5, False),
('Медведев Даниил Андреевич', '2003-04-27', 'г.Томск, Калинина ул., д. 23 кв.150', 'nika5557@mail.ru', 5, True),
('Лосева Нина Владимировна', '2001-09-10', 'г.Новосибирск, Хуторская ул., д. 11 кв.90', 'valeriya79@outlook.com', 5, True),
('Лебедев Артём Романович', '2003-08-21', 'г.Новосибирск, 3 Марта ул., д. 17 кв.50', 'kuzma91@rambler.ru', 5, False),
('Елисеева Александра Ярославовна', '2003-02-14', 'г.Новосибирск, Лесной пер., д. 8 кв.213', 'rada99@gmail.com', 5, False),
('Яшин Дмитрий Дмитриевич', '2001-10-01', 'г.Мочище, Луговая ул., д. 3 кв.39', 'tamara7482@mail.ru', 5, True);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Иванов Лев Владиславович', '2002-11-18', 'г.Новосибирск, Светлая ул., д. 6 кв.96', 'german26021968@outlook.com', 6, False),
('Мешкова Анастасия Никитична', '2000-03-04', 'г.Новосибирск, Речная ул., д. 17 кв.142', 'pavel36@outlook.com', 6, True),
('Ларионов Вадим Богданович', '2001-07-24', 'г.Бердск, Западная ул., д. 22 кв.19', 'emelyan38@yandex.ru', 6, False),
('Савельева Кира Ильинична', '2001-01-28', 'г.Новосибирск, Березовая ул., д. 21 кв.15', 'viktoriya.kutepova@gmail.com', 6, True),
('Бурова Малика Максимовна', '2002-07-23', 'г.Новосибирск, Строителей ул., д. 6 кв.156', 'lyubov73@gmail.com', 6, True),
('Трофимова Елизавета Дмитриевна', '2000-05-06', 'г.Мочище, Лесной пер., д. 20 кв.102', 'lev7311@mail.ru', 6, True),
('Басова Вера Романовна', '2004-01-16', 'г.Новосибирск, Песчаная ул., д. 21 кв.88', 'georgiy.nekrestyanov@gmail.com', 6, False),
('Воронцов Владимир Кириллович', '2001-12-22', 'г.Новосибирск, Школьная ул., д. 23 кв.182', 'maryamna7165@hotmail.com', 6, True),
('Власова Сафия Артёмовна', '2002-06-18', 'г.Новосибирск, Приозерная ул., д. 25 кв.32', 'yuriy.jgulev@rambler.ru', 6, False),
('Кузьмина Анастасия Львовна', '2000-08-24', 'г.Томск, Интернациональная ул., д. 25 кв.15', 'valentin1995@mail.ru', 6, True);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Горохова Лидия Матвеевна', '2001-04-20', 'г.Новосибирск, Комсомольская ул., д. 10 кв.13', 'tatyana9938@yandex.ru', 7, False),
('Иванов Эмир Владиславович', '2002-09-09', 'г.Бердск, Южная ул., д. 22 кв.99', 'egor33@yandex.ru', 7, True),
('Суворова Софья Тимофеевна', '2004-09-21', 'г.Новосибирск, Новая ул., д. 23 кв.8', 'yakov3206@outlook.com', 7, False),
('Куликова Дарья Дмитриевна', '2001-07-18', 'г.Новосибирск, Рабочая ул., д. 8 кв.167', 'danila.korjev@outlook.com', 7, True),
('Сазонова Кира Леонидовна', '2002-12-07', 'г.Бердск, Приозерная ул., д. 20 кв.163', 'margarita2079@gmail.com', 7, True),
('Карпова Мария Павловна', '2004-08-06', 'г.Новосибирск, Ленина ул., д. 11 кв.211', 'nastasya5069@yandex.ru', 7, True),
('Тихомиров Герман Макарович', '2004-02-20', 'г.Новосибирск, Чапаева ул., д. 17 кв.154', 'maryamna14@rambler.ru', 7, False);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Ширяева Аделина Ивановна', '2002-12-27', 'г.Новосибирск, Первомайская ул., д. 18 кв.100', 'veronika1990@yandex.ru', 8, False),
('Егоров Дмитрий Романович', '2000-03-16', 'г.Новосибирск, Лесной пер., д. 3 кв.176', 'yuliya07121994@ya.ru', 8, False),
('Шапошников Георгий Сергеевич', '2003-07-31', 'г.Новосибирск, Колхозная ул., д. 15 кв.110', 'egor6327@outlook.com', 8, False),
('Гуляева Марта Демидовна', '2002-10-10', 'г.Новосибирск, Победы ул., д. 17 кв.152', 'egor6327@outlook.com', 8, True),
('Данилов Никита Артёмович', '2003-03-27', 'г.Мочище, Озерная ул., д. 12 кв.214', 'aleksandra1981@ya.ru', 8, True),
('Громов Антон Александрович', '2004-01-24', 'г.Новосибирск, Якуба Коласа ул., д. 21 кв.148', 'egor80@mail.ru', 8, True),
('Моисеева София Платоновна', '2004-08-22', 'г.Мочище, Светлая ул., д. 21 кв.105', 'lana1960@mail.ru', 8, True),
('Филатова Дарья Сергеевна', '2003-12-16', 'г.Новосибирск, Лесной пер., д. 4 кв.94', 'filipp04021987@mail.ru', 8, True),
('Завьялов Артём Михайлович', '2001-03-14', 'г.Новосибирск, Луговая ул., д. 25 кв.128', 'afanasiya1968@mail.ru', 8, False),
('Морозов Даниил Ильич', '2002-01-25', 'г.Новосибирск, Молодежный пер., д. 1 кв.32', 'valentin64@mail.ru', 8, False);

insert INTO Students (name, date_of_birth, address, email, group_id, budget)
VALUES
('Моисеев Всеволод Ярославович', '2000-02-16', 'г.Новосибирск, Чкалова ул., д. 12 кв.178', 'valentin64@mail.ru', 9, False),
('Кузнецов Сергей Фёдорович', '2000-02-09', 'г.Бердск, Чкалова ул., д. 12 кв.178', 'anton1981@hotmail.com', 9, False),
('Виноградова Сабина Тимофеевна', '2002-04-15', 'г.Новосибирск, Октябрьский пер., д. 14 кв.72', 'yurin95@mail.ru', 9, True),
('Филимонова София Данииловна', '2000-05-01', 'г.Новосибирск, Полевая ул., д. 1 кв.11', 'rimma05021965@ya.ru', 9, False),
('Лазарев Максим Ильич', '2003-04-03', 'г.Бердск, Дружбы ул., д. 13 кв.129', 'german21011973@ya.ru', 9, False),
('Пономарев Давид Никитич', '2003-01-12', 'г.Мочище, Солнечный пер., д. 10 кв.98', 'alina14011965@rambler.ru', 9, False),
('Львова Ирина Руслановна', '2000-07-29', 'г.Новосибирск, Заречная ул., д. 10 кв.207', 'alina14011965@rambler.ru', 9, False),
('Щербакова Есения Дамировна', '2000-07-06', 'г.Новосибирск, 3 Марта ул., д. 14 кв.159', 'ulyana88@rambler.ru', 9, False);
